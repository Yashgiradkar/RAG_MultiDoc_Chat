...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            "/Users/yashgiradkar/Development/projects/LLMops-Project/data/NIPS-2017-attention-is-all-you-need-Paper.pdf",
        ]
        ...
        # retriever = ci.built_retriver(uploaded_files, chunk_size=2500, chunk_overlap=200, k=5, search_type="similarity")
